...
#courses details
$results = Get-CanvasApiResult -Uri "/api/v1/accounts/1/courses?enrollment_term_id=sis_term_id:A20" -Method GET
$results | convertto-Csv -NoTypeInformation
$results | Export-csv "courses.csv" -NoTypeInformation
$results | Select-Object id | Export-csv "Sync.csv" -NoTypeInformation
