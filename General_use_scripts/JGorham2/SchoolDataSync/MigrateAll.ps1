...
$TeacherList = import-csv C:\tmp\SDS\Teacher.csv
$TenantName = "wpi.edu"
...
foreach ($teacher in $TeacherList) {
    $UPN = $teacher.Username+"@wpi.edu"
    Convert-GrouptoTeam -UPN $UPN -TenantName $TenantName -authResult $authResult
}