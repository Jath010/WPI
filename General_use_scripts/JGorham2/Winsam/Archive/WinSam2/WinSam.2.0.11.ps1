...
#
# Version 2.0.11
# Last Updated: 2013-01-18 - tcollins
#
...
function GetFileshareMemberships($username){
    ...
    cls
    write-host '======================= WinSamaritan 2.0.11 ========================' -foregroundcolor Cyan
    write-host ''
    write-host 'Name                :' $displayname
    write-host 'Email               :' $userprincipalname
    write-host 'Title               :' $title
...
$arrdcs = (Get-ADDomainController -Filter * | Select HostName).HostName
$strDCHostname = $arrdcs[0].ToString()
