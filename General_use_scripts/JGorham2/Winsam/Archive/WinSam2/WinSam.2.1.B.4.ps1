...
#
# Version 2.1.B.4
# Last Updated: 2013-05-07 - tcollins
#
...
function GetFileshareMemberships($username){
    ...
    Clear-Host
    write-host '======================= WinSamaritan 2.1.B.4 ========================' -foregroundcolor Cyan
    write-host ''
    write-host 'Name                :' $displayname
    write-host 'Email               :' $userprincipalname
    write-host 'Title               :' $title
...
function ResetPIN ($username) {
    ...
    $connectionString = "Data Source=trng;User ID=wsamprox;Password=jdhr65_83bhdldh;Integrated Security=no"
