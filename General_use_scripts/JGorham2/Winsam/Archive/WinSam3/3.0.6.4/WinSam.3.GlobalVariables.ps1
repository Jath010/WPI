...
$Global:BetaAccessList += 'tcollins','tcollins2.test','kwheeler','glipin'
#$Global:BetaAccessList += 'tcollins','tcollins2.test','glipin','khweeler','jganouna','trhunt','cbtrivedi'
