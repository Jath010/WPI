...
If ($Host.Name -ne "Windows PowerShell ISE Host"){
    ...
    if ((Get-PSSession | Where {$_.ConfigurationName -match "Microsoft.Exchange"} -ErrorAction SilentlyContinue) -eq $null ) {
        ...
        $ExchangeServers = 'EXCHCAS-04','COUPE','FASTBACK','SN95','S281','S197','EXCHCAS-03'
...
3.0.9
    ...
    * [Pending] Adjust "Reset PIN" to validate usernames to see if they are valid.
