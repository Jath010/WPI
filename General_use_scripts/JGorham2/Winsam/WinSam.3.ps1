...
Version      : 4.0.0
Last Updated : 2019-02-22 - tcollins
...
# Powershell Modules
##################################################################################################################
$count=$null;$ExchangeOnlineSession=$null;$ErrorException=$null
...
Under development
3.x.0
    * Add SSPR/MFA queries??

Change Log
-------------
3.5.0 - 2019-02-22
    * Updated all mailbox commands to standardize on Exchange Online.
        * Removed the "cloud" prefix for all online commands.
        * Removed/Reduced any references to local/on-prem exchange commands.
    * Updated User Info
        * Included proxy address information
    * Consolidated Mailbox Info and Unified Group Info into a new Mail Resource lookup.
        * This takes an email address as an input, and determines what resource it is.
        * Once the type is determined, the output is given that is useful for the specific object.
3.2.1 - 2019-01-07
    * Fixed issue with "WinSam-Get-AccountInfo" function.  $AccountExpirationDate was not declared as a Global, and the use was notconsistant.
      Once the value was set as $Global:AccountExpirationDate the function worked correctly.
3.2.1 - 2018-12-11
    * Updated language on disable/expired users
3.2.0 - 2018-08-07
