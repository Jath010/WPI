...
$Alumni2018Users = $AlumniTotalUsers | Where {$_.AlumniPilotGroup -eq 'AlumniPilot2018'}
...
function WPI-Get-ExchangeStats ($ExchData) {
    ...
    $ActivityDate = Get-Date('07/01/18')
...
$Alumni2018UserStats = WPI-Get-ExchangeStats $Alumni2018Users
...
$body2table += "<tr><td colspan='3'> </td></tr>"
$body2table += "<tr bgcolor=#80a1d6><td colspan='3'>Alumni Pilot 2018 Mailboxes ($date)</td></tr>"
$body2table += "<tr bgcolor=#CCCCCC><td align='Left'>Data Point</td><td align='Center'>Count</td><td align='Center'>Percentage</td></tr>"
foreach ($item in $Alumni2018UserStats) {$body2table += "<tr><td>$($item.'Data Point')</td><td align='Right'>$($item.Count)</td><td align='Right'>$($item.Percentage)</td></tr>"}
$body2table += "<tr><td colspan='3'> </td></tr>"
...
$messageParameters2 = @{
    ...
    From    = 'its@wpi.edu'
    #To      = 'tcollins@wpi.edu'
    To      = 'cdrenaud@wpi.edu','ccerny@wpi.edu','ajdealy@wpi.edu','amcmahon@wpi.edu','pthomas@wpi.edu','jjaeger@wpi.edu','hhamerstrom@wpi.edu'
